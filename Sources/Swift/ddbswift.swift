...
func allocToneFileInfo() -> UnsafeMutablePointer<toneFileInfo>  {
    let ptr: UnsafeMutablePointer<toneFileInfo> = UnsafeMutablePointer<toneFileInfo>.allocate(capacity: 1)
...
func read(info: UnsafeMutablePointer<DB_fileinfo_t>?, bytes: UnsafeMutablePointer<CChar>?, size: Int32) -> Int32 {
    // print("swift: read")
